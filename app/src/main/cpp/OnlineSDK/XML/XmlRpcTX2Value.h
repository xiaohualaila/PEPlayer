#ifndef CAM360_LIB_XMLRPCTX2UTIL_XMLRPCTX2VALUE_H_
#define CAM360_LIB_XMLRPCTX2UTIL_XMLRPCTX2VALUE_H_
#include <time.h>
#include <exception>
#include <map>
#include <memory>
...
namespace XmlRpcTX2Value {
	...
	public:
        ...
        XmlRpcValue(tinyxml2::XMLElement * value) : _type(TypeInvalid)
        {
            if (!fromXml(value)) _type = TypeInvalid;
        }
        ...
        bool fromXml(tinyxml2::XMLElement * value);

		//! Encode the Value in xml
		//std::string toXml() const;
        bool toXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
	...
	protected:
		...
		// XML decoding
        bool boolFromXml(tinyxml2::XMLElement * value_type);
        bool intFromXml(tinyxml2::XMLElement * value_type);
        bool doubleFromXml(tinyxml2::XMLElement * value_type);
        bool stringFromXml(tinyxml2::XMLElement * value_type);
        bool timeFromXml(tinyxml2::XMLElement * value_type);
        bool binaryFromXml(tinyxml2::XMLElement * value_type);
        bool arrayFromXml(tinyxml2::XMLElement * value_type);
        bool structFromXml(tinyxml2::XMLElement * value_type);

		// XML encoding
        bool boolToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool intToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool doubleToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool stringToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool timeToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool binaryToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool arrayToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
        bool structToXml(tinyxml2::XMLDocument *doc, tinyxml2::XMLElement ** value);
...
#endif // CAM360_LIB_XMLRPCTX2UTIL_XMLRPCTX2VALUE_H_
